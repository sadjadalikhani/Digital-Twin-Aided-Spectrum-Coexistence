...
params.num_ant_BS = [1,16,1];      % Number of antenna elements for the BS arrays in the x,y,z-axes
...
params.num_ant_UE = [1,4,4];      % Number of antenna elements for the user arrays in the x,y,z-axes
